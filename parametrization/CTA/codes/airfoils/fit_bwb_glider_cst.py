...
DEGREE = 5
# With shared leading edge enabled, the default Kulfan exponents (0.5, 1.0)
# over-constrain the front half of some glider sections. A slightly rounder
# class function tracks the real nose/forebody shape better while keeping the
# order-5 CTA-compatible parametrization.
N1 = 0.35
N2 = 1.1
SHARED_LEADING_EDGE = True
SMOOTHNESS_WEIGHT = 1.0e-2
# Fit from the leading edge itself. In practice this removes a small but
# persistent nose mismatch that appeared when trimming the first 0.5% chord.
FIT_XMIN = 0.0
FIT_XMAX = 0.99
